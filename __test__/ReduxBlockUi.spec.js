  ...
  describe('block prop', () => {
    ...
    describe('with a function value', () => {
      it('should block when the function returns true', () => {
        const wrapper = shallow(<ReduxBlockUi block={useCallback(() => true, [])}>Yo!</ReduxBlockUi>);
        const instance = wrapper.instance();
        instance.middleware({
          type: 'fetching'
        });
      ...
      it('should not block when the function does not return true', () => {
        const wrapper = shallow(<ReduxBlockUi block={useCallback(() => undefined, [])}>Yo!</ReduxBlockUi>);
        const instance = wrapper.instance();
        instance.middleware({
          type: 'something-else'
        });
  ...
  describe('unblock prop', () => {
    ...
    describe('with a function value', () => {
      it('should unblock when the function returns true', () => {
        const wrapper = shallow(<ReduxBlockUi unblock={useCallback(() => true, [])}>Yo!</ReduxBlockUi>);
        const instance = wrapper.instance();
        instance.blocking = 1;
        wrapper.setState({
          blocking: 1
      ...
      it('should not unblock when the function does not return true', () => {
        const wrapper = shallow(<ReduxBlockUi unblock={useCallback(() => undefined, [])}>Yo!</ReduxBlockUi>);
        const instance = wrapper.instance();
        instance.blocking = 1;
        wrapper.setState({
          blocking: 1
